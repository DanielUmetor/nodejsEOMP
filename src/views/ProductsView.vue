        ...
        <div v-else class="col-md-4" v-for="product in sortedProducts" :key="product.prodID">
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <router-link :to="{ name: 'singleProduct', params: { id: product.prodID } }" class="btn btn-primary">View Details</router-link>
...
export default {
  ...
  methods: {
    searchProducts() {
      // You can add logic here to handle search button click
    },
    sortProducts() {
      this.sortOrder = this.sortOrder === 1 ? -1 : 1
    }
